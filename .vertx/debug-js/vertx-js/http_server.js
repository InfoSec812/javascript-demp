...
var HttpServer = function(j_val) {
  ...
  this.requestHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return new HttpServer(j_httpServer["requestHandler(io.vertx.core.Handler)"](function(jVal) {
  ...
  this.websocketHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return new HttpServer(j_httpServer["websocketHandler(io.vertx.core.Handler)"](function(jVal) {
