...
var Vertx = function(j_val) {
  ...
  this.createNetServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return new NetServer(j_vertx["createNetServer(io.vertx.core.net.NetServerOptions)"](__args[0] != null ? new NetServerOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.createNetClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return new NetClient(j_vertx["createNetClient(io.vertx.core.net.NetClientOptions)"](__args[0] != null ? new NetClientOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.createHttpServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return new HttpServer(j_vertx["createHttpServer(io.vertx.core.http.HttpServerOptions)"](__args[0] != null ? new HttpServerOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.createHttpClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return new HttpClient(j_vertx["createHttpClient(io.vertx.core.http.HttpClientOptions)"](__args[0] != null ? new HttpClientOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.createDatagramSocket = function() {
    ...
    if (__args.length === 0) {
      ...
      return new DatagramSocket(j_vertx["createDatagramSocket(io.vertx.core.datagram.DatagramSocketOptions)"](__args[0] != null ? new DatagramSocketOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.createDnsClient = function(port, host) {
    ...
    if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'string') {
      return new DnsClient(j_vertx["createDnsClient(int,java.lang.String)"](port, host));
    } else utils.invalidArgs();
  };
  ...
  this.timerStream = function(delay) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return new TimeoutStream(j_vertx["timerStream(long)"](delay));
    } else utils.invalidArgs();
  };
  ...
  this.periodicStream = function(delay) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return new TimeoutStream(j_vertx["periodicStream(long)"](delay));
    } else utils.invalidArgs();
  };
...
Vertx.vertx = function() {
  ...
  if (__args.length === 0) {
    ...
    return new Vertx(JVertx["vertx(io.vertx.core.VertxOptions)"](__args[0] != null ? new VertxOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
  } else utils.invalidArgs();
};
