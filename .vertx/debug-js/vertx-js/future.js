...
Future.succeededFuture = function() {
  ...
  if (__args.length === 0) {
    ...
    return new Future(JFuture["succeededFuture(java.lang.Object)"](utils.convParamTypeUnknown(__args[0])));
  } else utils.invalidArgs();
};
...
Future.failedFuture = function(failureMessage) {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'string') {
    return new Future(JFuture["failedFuture(java.lang.String)"](failureMessage));
  } else utils.invalidArgs();
};
