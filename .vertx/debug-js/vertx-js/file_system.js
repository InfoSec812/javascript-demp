...
var FileSystem = function(j_val) {
  ...
  this.propsBlocking = function(path) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return new FileProps(j_fileSystem["propsBlocking(java.lang.String)"](path));
    } else utils.invalidArgs();
  };
  ...
  this.lpropsBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return new FileProps(j_fileSystem["lpropsBlocking(java.lang.String)"](path));
    } else utils.invalidArgs();
  };
  ...
  this.readFileBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return new Buffer(j_fileSystem["readFileBlocking(java.lang.String)"](path));
    } else utils.invalidArgs();
  };
  ...
  this.openBlocking = function(path, options) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'object') {
      return new AsyncFile(j_fileSystem["openBlocking(java.lang.String,io.vertx.core.file.OpenOptions)"](path, options != null ? new OpenOptions(new JsonObject(JSON.stringify(options))) : null));
    } else utils.invalidArgs();
  };
  ...
  this.fsPropsBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return new FileSystemProps(j_fileSystem["fsPropsBlocking(java.lang.String)"](path));
    } else utils.invalidArgs();
  };
